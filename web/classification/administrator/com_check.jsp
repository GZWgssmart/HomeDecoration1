    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><a href="javascript:history.go(-1)" >返回</a></strong> / <small>装修公司审核</small></div>
            </div>
                        ...
                        <div class="am-panel-bd am-scrollable-horizontal">
                            ...
                            am-text-nowrap">
                                ...
                                <c:forEach items="${requestScope.comList }" var="com" varStatus="status">
	                                <tr>
	                                    ...
	                                    <td>${com.principal }</td>
	                                    <td>
	                                    	<c:if test="${com.checked == 'Y' }">
		                                    	通过
		                                    </c:if>
		                                    <c:if test="${com.checked == 'N' }">
		                                    	审核中
		                                    </c:if>
	                                    </td>
	                                    <td>${com.created_time }</td>
	                                    <td><button type="button" class="am-btn am-btn-primary" data-am-modal="{target: '#my-popup'}">查看</button>
	                                        <div class="am-popup" id="my-popup">
	                                            <div class="am-popup-inner">
	                                                ...
	                                                <li>设计师名称：${com.name }</li>
	                                                <li>邮箱：${com.email }</li>
	                                                <li>地址：${com.address }</li>
	                                                <li>手机号：${com.phone }</li>
	                                                <li>负责人：${com.principal }</li>
	                                                <li>审核状态：
	                                                	<c:if test="${com.checked == 'Y' }">
					                                    	通过
					                                    </c:if>
	                                                ...
	                                                <li>申请时间：${com.created_time }</li>
	                                                </ul>
	                                            </div>
	                                        </div>
	                                        <a class="am-btn am-btn-primary" href="<%=path %>/adm/compass?id=${com.id }&email=${com.email }">通过</a>
	                                    </td>
	                                </tr>
                                </c:forEach>
                            </table>
							...
							<ul class="am-pagination am-pagination-centered">
                                <c:choose>
									...
									<c:otherwise>
										<li><a href="<%=path %>/adm/comp_check?pageNo=1" class="am-btn">&laquo;首页</a></li>
	                                	<li><a href="<%=path %>/adm/comp_check?pageNo=${requestScope.pageNo - 1 }" class="am-btn">上一页</a></li>
									</c:otherwise>
								</c:choose>
								<c:choose>
									...
									<c:otherwise>
										<li><a href="<%=path %>/adm/comp_check?pageNo=${requestScope.pageNo + 1 }" class="am-btn">下一页</a></li>
                                		<li><a href="<%=path %>/adm/comp_check?pageNo=${requestScope.pageCount }" class="am-btn">尾页&raquo;</a></li>
									</c:otherwise>
								</c:choose>
