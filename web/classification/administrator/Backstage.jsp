    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><a href="javascript:history.go(-1)" >返回</a></strong> / <small>管理员个人资料</small></div>
            </div>
                    ...
                    <div class="am-panel am-panel-default">
                        <div class="am-panel-bd">
                            ...
                            <ul class="am-list am-list-static am-g-fixed">
                                <li>管理员名称：${sessionScope.admin.name }</li>
                                <li>邮箱：${sessionScope.admin.email }</li>
                                <li>手机号：${sessionScope.admin.phone }</li>
                                <li>权限：${sessionScope.admin.role }</li>
                            </ul>
                        </div>
                    </div>
                </div>
