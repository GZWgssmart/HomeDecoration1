    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><a href="javascript:history.go(-1)" >返回</a></strong> / <small>编辑案例</small></div>
            </div>
            ...
            <div class="am-g">
                <div class="am-u-sm-12 am-u-lg-10 am-u-lg-offset-1">
                    <div class="am-panel am-panel-default">
					  ...
					  <input type="hidden" id="id" name="id" value="${requestScope.edit.id }"/>
                                <div class="am-form-group">
                                    <label for="name" class="am-u-sm-2 am-form-label">案例名称</label>
                                    <div class="am-u-sm-10">
                                        <input type="text" id="name" name="name" value="${requestScope.edit.name }">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-10">
                                        <input type="text" id="polt_name" name="polt_name" value="${requestScope.edit.plot_name }">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-10">
                                        <input type="text" id="style" name="style" value="${requestScope.edit.style }">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-10">
                                        <textarea class="" rows="5" id="des" name="des">${requestScope.edit.des }</textarea>
                                    </div>
                                </div>
                                ...
                                <ul class="am-avg-sm-5 am-thumbnails">
                                    <li>
                                        <div class="am-form-group am-form-file">
                                            <a href="#"><img class="am-thumbnail" src="<%=path %>/${requestScope.edit.image_1 }" /></a>
                                            <input id="image_1" name="image_1" type="file" multiple>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="am-form-group am-form-file">
                                            <a href="#"><img class="am-thumbnail" src="<%=path %>/${requestScope.edit.image_2 }" /></a>
                                            <input id="image_2" name="image_2" type="file" multiple>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="am-form-group am-form-file">
                                            <a href="#"><img class="am-thumbnail" src="<%=path %>/${requestScope.edit.image_3 }" /></a>
                                            <input id="image_3" name="image_3" type="file" multiple>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="am-form-group am-form-file">
                                            <a href="#"><img class="am-thumbnail" src="<%=path %>/${requestScope.edit.image_4 }" /></a>
                                            <input id="image_4" name="image_4" type="file" multiple>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="am-form-group am-form-file">
                                            <a href="#"><img class="am-thumbnail" src="<%=path %>/${requestScope.edit.image_5 }" /></a>
                                ...
                                <div class="am-form-group">
                                    <div class="am-u-sm-10 am-u-sm-offset-2">
                                        <input type="button" class="am-btn am-btn-primary am-btn-block" value="提交案例" onclick="designer_case_edit();"/>
                                    </div>
                                </div>
                            </form>
                        </div>
