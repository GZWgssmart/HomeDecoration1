                    ...
                    <div class="am-panel am-panel-default">
                        <div class="am-panel-bd">
                            ...
                            <form id="form" method="post" class="am-form am-form-horizontal">
                                ...
                                <input type="hidden" id="email" name="email" value="${sessionScope.designer.email }">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-form-group">
                                    <div class="am-u-sm-10 am-u-sm-offset-2">
                                        <input type="button" value="提交修改" onclick="des_pwd();" class="am-btn am-btn-primary am-btn-block">
                                    </div>
                                </div>
                            </form>
                        </div>
