                ...
                <div class="am-u-sm-12 am-u-lg-10 am-u-lg-offset-1">
                    <div class="am-panel am-panel-default">
                        <div class="am-panel-bd">
                            ...
                            <hr>
                            <div>
                                <p class="am-text-xxl am-text-center font-style"><a href="<%=path %>/BHdes/des?id=${requestScope.des.id }">${requestScope.des.name }</a>的所有案例</p>
                            </div>
                            <hr>
                            <div>
                            <div class="am-g">
                            ...
                            <div class="am-g">
                                <c:forEach items="${requestScope.desCaseList }" var="desCase" begin="3" end="5" varStatus="status">
		                                <div class="am-u-sm-4">
		                                    <div class="am-thumbnail" id="desCases2">
		                                        <a href="<%=path %>/BHdes/desCase?id=${desCase.id }"><img src="<%=path %>/${desCase.image_1 }" alt="" class="img-rounded"/></a>
		                                        <div class="am-thumbnail-caption">
		                                            <h4>${desCase.name }</h4>
		                                            <p class="am-text-truncate">${desCase.des }</p>
                            ...
                            <div class="am-g">
                                <c:forEach items="${requestScope.desCaseList }" var="desCase" begin="6" end="8" varStatus="status">
		                                <div class="am-u-sm-4">
		                                    <div class="am-thumbnail" id="desCases3">
		                                        <a href="<%=path %>/BHdes/desCase?id=${desCase.id }"><img src="<%=path %>/${desCase.image_1 }" alt="" class="img-rounded"/></a>
		                                        <div class="am-thumbnail-caption">
		                                            <h4>${desCase.name }</h4>
		                                            <p class="am-text-truncate">${desCase.des }</p>
                            ...
                            <hr>
                                    ...
                                    <div class="am-g">
		                                ...
		                                <div class="am-u-sm-4">
		                                    <div class="am-thumbnail" id="desCases4">
		                                        <a href="<%=path %>/BHdes/desCase?id=${desCase.id }"><img src="<%=path %>/${desCase.image_1 }" alt="" class="img-rounded"/></a>
		                                        <div class="am-thumbnail-caption">
		                                            <h4>${desCase.name }</h4>
		                                            <p class="am-text-truncate">${desCase.des }</p>
                                ...
                                <c:choose>
									...
									<c:otherwise>
										<li><a href="<%=path %>/BHdes/desCaseMore?pageNo=1&id=${requestScope.des.id}" class="am-btn">&laquo;首页</a></li>
	                                	<li><a href="<%=path %>/BHdes/desCaseMore?pageNo=${requestScope.pageNo - 1 }&id=${requestScope.des.id }" class="am-btn">上一页</a></li>
									</c:otherwise>
								</c:choose>
								<c:choose>
									...
									<c:otherwise>
										<li><a href="<%=path %>/BHdes/desCaseMore?pageNo=${requestScope.pageNo + 1 }&id=${requestScope.des.id }" class="am-btn">下一页</a></li>
                                		<li><a href="<%=path %>/BHdes/desCaseMore?pageNo=${requestScope.pageCount }&id=${requestScope.des.id }" class="am-btn">尾页&raquo;</a></li>
									</c:otherwise>
								</c:choose>
