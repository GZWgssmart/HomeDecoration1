                ...
                <div class="am-u-sm-12 am-u-lg-10 am-u-lg-offset-1">
                    <div class="am-panel am-panel-default">
                        <div class="am-panel-bd">
                            ...
                            <div>
	                            <input type="hidden" id="id" value="${requestScope.sup.id }" />
	                            <input type="hidden" id="cus_id" value="${sessionScope.customer.id }" />
	                            <input type="hidden" id="longitude" value="${requestScope.sup.longitude }">
                                    <input type="hidden" id="latitude" value="${requestScope.sup.latitude }">
                                <p class="am-text-xxl am-text-center font-style">${requestScope.sup.name }
                                <c:if test="${requestScope.saved == false }">
	                               		<a onclick="save_sup();" id="save" type="button" class="am-btn am-btn-success am-round am-fr">收藏建材商</a>
	                               	</c:if>
                                ...
                                <div class="am-panel-bd">
                                	<div class="avatar am-align-left">
	                                    <p class="am-align-left">
	                                        <img src="<%=path %>/${requestScope.sup.logo }" class="am-img-thumbnail am-circle avatar" alt=""/>
	                                    </p>
	                                </div>
                                    <br/>
                                    <p class="am-text-lg">建材商名称：<a href="<%=path %>/BHsup/sup?id=${requestScope.sup.id }">${requestScope.sup.name }</a></p>
                                    <p class="am-text-lg">邮箱：${requestScope.sup.email }</p>
                                    <p class="am-text-lg">地址：${requestScope.sup.address }</p>
                                    <p class="am-text-lg">负责人：${requestScope.sup.principal }</p>
                                    
                                    <hr>
                                    <blockquote class="font-style">
                                        <dl>
                                            <dt>描述</dt>
                                            <dd>${requestScope.sup.des }</dd>
                                        </dl>
                            ...
                            <div class="am-cf am-padding">
                                <div class="am-fl am-cf"><strong class="am-text-primary am-text-xl">建材商品精选</strong></div>
                            </div>

                            <div class="am-g">
                                <c:forEach items="${requestScope.proTopList }" var="topPro" end="2" varStatus="status">
	                                <div class="am-u-sm-4">
	                                    <div class="am-thumbnail" id="sup1">
                            ...
                            <a href="<%=path %>/BHsup/proMore?id=${requestScope.sup.id }" type="button" class="am-btn am-btn-secondary am-round am-fr">更多商品</a>
                            <hr>
                            
                            <div class="am-cf am-padding">
                                <div class="am-fl am-cf"><strong class="am-text-primary am-text-xl">建材活动精选</strong></div>
                            </div>
                            
                            <div class="am-g">
                                <c:forEach items="${requestScope.actTopList }" var="topAct" end="2" varStatus="status">
	                                <div class="am-u-sm-4">
	                                    <div class="am-thumbnail"  id="sup2">
                            ...
                            <a href="<%=path %>/BHsup/supActMore?id=${requestScope.sup.id }" type="button" class="am-btn am-btn-secondary am-round am-fr">更多活动</a>
                            <hr>
