                ...
                <div class="am-u-sm-12 am-u-lg-10 am-u-lg-offset-1">
                    <div class="am-panel am-panel-default">
                        <div class="am-panel-bd">
                            ...
                            <div>
                            	<input type="hidden" id="id" value="${requestScope.supAct.id }" />
	                            <input type="hidden" id="cus_id" value="${sessionScope.customer.id }" />
                                <p class="am-text-xxl am-text-center font-style">${requestScope.supAct.name }
                            </div>
                                <hr>
                                ...
                                <div class="examples">
                                    <div class="row">
                                        <div class="example  col-xs-12 col-md-12">
                                            <p><img src="<%=path %>/${requestScope.supAct.image }" class="img-rounded" alt=""></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <section class="am-panel am-panel-default">
                                ...
                                <div class="am-panel-bd">
                                    ...
                                    <p class="am-text-lg">活动名称：${requestScope.supAct.name }</p>
                                    <hr>
                                    <blockquote class="font-style">
                                    <dl>
                                        <dt>活动描述</dt>
                                        <dd>${requestScope.supAct.des }</dd>
                                        </dl>
                            ...
                            <div class="am-g">
                                <c:forEach items="${requestScope.actTopList }" var="topAct" end="2" varStatus="status">
	                                <div class="am-u-sm-4">
	                                    <div class="am-thumbnail" id="am-sup_act">
                            ...
                            <div class="am-g">
                                <c:forEach items="${requestScope.proTopList }" var="pro" end="2" varStatus="status">
	                                <div class="am-u-sm-4">
	                                    <div class="am-thumbnail" id="am-sup_pro">
	                                        <a href="<%=path %>/BHsup/supAct?id=${pro.id }"><img src="<%=path %>/${pro.image }" alt="" class="img-rounded"/></a>
	                                        <div class="am-thumbnail-caption">
	                                            <h4>商品名称：${pro.name }</h4>
