                    ...
                    <div class="am-panel am-panel-default">
                        <div class="am-panel-bd">
                            <div class="am-cf am-padding">
                                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><a href="javascript:history.go(-1)" >返回</a></strong> / <small>建材</small></div>
                            </div>
                            <hr>
                            <div>
                                <p class="am-text-xxl am-text-center font-style"><a href="<%=path %>/BHsup/sup?id=${requestScope.sup.id }">${requestScope.sup.name }</a>的所有建材</p>
                            </div>
                            <hr>
                            <div>
                            <div class="am-g">
                                <c:forEach items="${requestScope.proList }" var="pro" end="2" varStatus="status">
		                                <div class="am-u-sm-4">
		                                    <div class="am-thumbnail" id="pros1">
                            ...
                            <hr>
                            <div class="am-g">
                                <c:forEach items="${requestScope.proList }" var="pro" begin="3" end="5" varStatus="status">
		                                <div class="am-u-sm-4">
		                                    <div class="am-thumbnail" id="pros2">
		                                        <a href="<%=path %>/BHsup/pro?id=${pro.id }"><img src="<%=path %>/${pro.image }" alt="" class="img-rounded"/></a>
		                                        <div class="am-thumbnail-caption">
		                                            <h4>商品名称：${pro.name }</h4>
		                                            <p class="am-text-truncate">仅售：${pro.sale_price }元</p>
                            ...
                            <div class="am-g">
                                <c:forEach items="${requestScope.proList }" var="pro" begin="6" end="8" varStatus="status">
		                                <div class="am-u-sm-4">
		                                    <div class="am-thumbnail" id="pros3">
		                                        <a href="<%=path %>/BHsup/pro?id=${pro.id }"><img src="<%=path %>/${pro.image }" alt="" class="img-rounded"/></a>
		                                        <div class="am-thumbnail-caption">
		                                            <h4>商品名称：${pro.name }</h4>
		                                            <p class="am-text-truncate">仅售：${pro.sale_price }元</p>
                            ...
                            <hr>
                                <div class="am-g">
                                    <c:forEach items="${requestScope.proList }" var="pro" begin="9" end="11" varStatus="status">
                              <div class="am-u-sm-4">
                                  <div class="am-thumbnail" id="pros4">
                                      <a href="<%=path %>/BHsup/pro?id=${pro.id }"><img src="<%=path %>/${pro.image }" alt="" class="img-rounded"/></a>
                                      <div class="am-thumbnail-caption">
                                          <h4>商品名称：${pro.name }</h4>
                                          <p class="am-text-truncate">仅售：${pro.sale_price }元</p>
                                ...
                                <c:choose>
									...
									<c:otherwise>
										<li><a href="<%=path %>/BHsup/proMore?pageNo=1&id=${requestScope.sup.id}" class="am-btn">&laquo;首页</a></li>
	                                	<li><a href="<%=path %>/BHsup/proMore?pageNo=${requestScope.pageNo - 1 }&id=${requestScope.sup.id }" class="am-btn">上一页</a></li>
									</c:otherwise>
								</c:choose>
								<c:choose>
									...
									<c:otherwise>
										<li><a href="<%=path %>/BHsup/proMore?pageNo=${requestScope.pageNo + 1 }&id=${requestScope.sup.id }" class="am-btn">下一页</a></li>
                                		<li><a href="<%=path %>/BHsup/proMore?pageNo=${requestScope.pageCount }&id=${requestScope.sup.id }" class="am-btn">尾页&raquo;</a></li>
									</c:otherwise>
								</c:choose>
