                    ...
                    <div class="am-panel am-panel-default">
                        <div class="am-panel-bd">
                            <div class="am-cf am-padding">
                                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><a href="javascript:history.go(-1)" >返回</a></strong> / <small>活动</small></div>
                            </div>
                            <hr>
                            <div>
                                <p class="am-text-xxl am-text-center font-style">所有建材活动</p>
                            </div>
                            <hr>
                            ...
                            <div>
                                ...
                                <div class="am-g">
                                    <c:forEach items="${requestScope.supActList }" var="supAct" begin="3" end="5" varStatus="status">
		                                <div class="am-u-sm-4">
		                                    <div class="am-thumbnail"  id="act2">
		                                        <a href="<%=path %>/BHsup/supAct?id=${supAct.id }"><img src="<%=path %>/${supAct.image }" alt="" class="img-rounded"/></a>
		                                        <div class="am-thumbnail-caption">
		                                            <h4>活动名称：${supAct.name }</h4>
		                                            <p class="am-text-truncate">简介：${supAct.des }</p>
                                ...
                                <div class="am-g">
                                    <c:forEach items="${requestScope.supActList }" var="supAct" begin="6" end="8" varStatus="status">
		                                <div class="am-u-sm-4">
		                                    <div class="am-thumbnail"  id="act3">
		                                        <a href="<%=path %>/BHsup/supAct?id=${supAct.id }"><img src="<%=path %>/${supAct.image }" alt="" class="img-rounded"/></a>
		                                        <div class="am-thumbnail-caption">
		                                            <h4>活动名称：${supAct.name }</h4>
		                                            <p class="am-text-truncate">简介：${supAct.des }</p>
                                ...
                                <div class="am-g">
                                    <c:forEach items="${requestScope.supActList }" var="supAct" begin="9" end="11" varStatus="status">
		                                <div class="am-u-sm-4">
		                                    <div class="am-thumbnail"  id="act4">
		                                        <a href="<%=path %>/BHsup/supAct?id=${supAct.id }"><img src="<%=path %>/${supAct.image }" alt="" class="img-rounded"/></a>
		                                        <div class="am-thumbnail-caption">
		                                            <h4>活动名称：${supAct.name }</h4>
		                                            <p class="am-text-truncate">简介：${supAct.des }</p>
                            ...
                            <div>
                                ...
                                <c:choose>
									...
									<c:otherwise>
										<li><a href="<%=path %>/BHsup/allAct?pageNo=1" class="am-btn">&laquo;首页</a></li>
	                                	<li><a href="<%=path %>/BHsup/allAct?pageNo=${requestScope.pageNo -1 }" class="am-btn">上一页</a></li>
									</c:otherwise>
								</c:choose>
								<c:choose>
									...
									<c:otherwise>
										<li><a href="<%=path %>/BHsup/allAct?pageNo=${requestScope.pageNo + 1 }" class="am-btn">下一页</a></li>
                                		<li><a href="<%=path %>/BHsup/allAct?pageNo=${requestScope.pageCount }" class="am-btn">尾页&raquo;</a></li>
									</c:otherwise>
								</c:choose>
