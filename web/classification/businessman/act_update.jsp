    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><a href="javascript:history.go(-1)" >返回</a></strong> / <small>修改活动</small></div>
            </div>
                    ...
                    <div class="am-panel am-panel-default">
                        <div class="am-panel-bd">
                            ...
                            <form id="form" class="am-form am-form-horizontal" method="post" action="" enctype="multipart/form-data">
                                ...
                                <input type="hidden" id="id" name="id" value="${requestScope.active.id }">
                                <div class="am-form-group">
                                    <label for="name" class="am-u-sm-2 am-form-label">活动名称</label>
                                    <div class="am-u-sm-10">
                                        <input type="text" id="name" name="name" value="${requestScope.active.name }">
                                    </div>
                                </div>

                                <div class="am-form-group">
                                    <label for="des" class="am-u-sm-2 am-form-label">活动描述</label>
                                    <div class="am-u-sm-10">
                                        <textarea class="" rows="5" id="des" name="des">${requestScope.active.des }</textarea>
                                    </div>
                                </div>
                                    ...
                                    <ul class="am-avg-sm-1 am-thumbnails">
                                        <li>
                                            <div class="am-form-group am-form-file">
                                                <a href="#"><img class="am-thumbnail" src="<%=path %>/${requestScope.active.image }" /></a>
                                ...
                                <div class="am-form-group">
                                    <div class="am-u-sm-12">
                                        <input type="button" class="am-btn am-btn-primary am-btn-block" value="确认修改" onclick="update_act();"/>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<script src="<%=path %>/js/supply-active.js"></script>
</body>
</html>