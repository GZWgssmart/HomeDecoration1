    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><a href="javascript:history.go(-1)" >返回</a></strong> / <small>修改商品</small></div>
            </div>
                    ...
                    <div class="am-panel am-panel-default">
                        <div class="am-panel-bd">
                            ...
                            <form id="form" class="am-form am-form-horizontal" method="post" action="" enctype="multipart/form-data">
                                ...
                                <input type="hidden" id="id" name="id" value="${requestScope.product.id }">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-10">
                                        <input type="text" id="sale_price" name="sale_price" value="${requestScope.product.sale_price }">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-10">
                                        <textarea class="" rows="5" id="des" name="des">${requestScope.product.des }</textarea>
                                    </div>
                                </div>
                                    ...
                                    <ul class="am-avg-sm-1 am-thumbnails">
                                        <li>
                                            <div class="am-form-group am-form-file">
                                                <a href="#"><img class="am-thumbnail" src="<%=path %>/${requestScope.product.image }" /></a>
                                ...
                                <div class="am-form-group">
                                    <div class="am-u-sm-12">
                                        <input type="button" class="am-btn am-btn-primary am-btn-block" value="提交商品" onclick="update_pro();"/>
                                    </div>
                                </div>
                            </form>
                        </div>
