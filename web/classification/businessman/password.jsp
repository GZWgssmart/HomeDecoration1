                ...
                <div class="am-u-sm-12 am-u-lg-10 am-u-lg-offset-1">
                    <div class="am-panel am-panel-default">
                        <div class="am-panel-bd">
                            ...
                            <input type="hidden" id="email" name="email" value="${sessionScope.supply.email }">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-form-group">
                                    <div class="am-u-sm-10 am-u-sm-offset-2">
                                        <input type="button" onclick="supply_pwd();" class="am-btn am-btn-primary am-btn-block" value="提交修改" />
                                    </div>
                                </div>
                            </form>
