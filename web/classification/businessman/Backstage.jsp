                    ...
                    <div class="am-panel am-panel-default">
                        <div class="am-panel-bd">
                            ...
                            <ul class="am-list am-list-static am-g-fixed">
                                <li>商户名称：${sessionScope.supply.name }</li>
                                <li>邮箱：${sessionScope.supply.email }</li>
                                <li>固定电话：${sessionScope.supply.tel }</li>
                                <li>手机号：${sessionScope.supply.phone }</li>
                                <li>负责人：${sessionScope.supply.principal }</li>
                                <li>地址：${sessionScope.supply.address }</li>
                                <li>成立时间：${sessionScope.supply.open_date }</li>
                                <li>经度：${sessionScope.supply.longitude }</li>
                                <li>纬度：${sessionScope.supply.latitude }</li>
                            </ul>
                        </div>
                    </div>
                </div>
