                ...
                <div class="am-u-sm-12 am-u-lg-10 am-u-lg-offset-1">
                    ...
                    <span id="error">${requestScope.error }</span>
                        <div class="am-panel-bd">
                            <form id="form" method="post" action="<%=path %>/supply/headupdate" class="am-form am-form-horizontal" enctype="multipart/form-data">
                                <img class="am-radius avatar am-center am-img-responsive" alt="${sessionScope.supply.name }" src="<%=path %>/${sessionScope.supply.logo }" />
                                <hr>
