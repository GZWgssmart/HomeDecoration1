    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><a href="javascript:history.go(-1)" >返回</a></strong> / <small>添加活动</small></div>
            </div>
                        ...
                        <div class="am-panel-bd">
                            ...
                            <form id="form" class="am-form am-form-horizontal" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-10">
                                        <textarea class="" rows="5" id="des" name="des" placeholder="请输入活动描述"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    <div class="am-u-sm-12">
                                        <input type="button" class="am-btn am-btn-primary am-btn-block" value="提交商品" onclick="add_act();"/>
                                    </div>
                                </div>
                            </form>
                        </div>
