    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><a href="javascript:history.go(-1)" >返回</a></strong> / <small>商品详情</small></div>
            </div>
                        ...
                        <div class="am-panel-bd">
                            ...
                            <form id="form" class="am-form am-form-horizontal">
                                <div class="am-form-group">
                                    <label class="am-u-sm-4 am-u-sm-offset-4 am-form-label">商品名称：${requestScope.product.name }</label>
                                </div>

                                <div class="am-form-group">
                                    <label class="am-u-sm-4 am-u-sm-offset-4 am-form-label">商品原价：${requestScope.product.price }</label>
                                </div>

                                <div class="am-form-group">
                                    <label class="am-u-sm-4 am-u-sm-offset-4 am-form-label">商品售价：${requestScope.product.sale_price }</label>
                                </div>

                                <div class="am-form-group">
                                    <label class="am-u-sm-4 am-u-sm-offset-4 am-form-label">商品描述：${requestScope.product.des }</label>
                                </div>
                                    ...
                                    <ul class="am-avg-sm-1 am-thumbnails">
                                        <li>
                                            <div class="am-form-group am-form-file">
                                                <img style="width:100%" src="<%=path %>/${requestScope.product.image }" />
                                            </div>
                                        </li>
                                    </ul>
                                </div>
