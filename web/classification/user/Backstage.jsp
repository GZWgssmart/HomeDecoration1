    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><a href="javascript:history.go(-1)" >返回</a></strong> / <small>个人资料</small></div>
            </div>
                    ...
                    <div class="am-panel am-panel-default">
                        <div class="am-panel-bd">
                            ...
                            <ul class="am-list am-list-static am-g-fixed">
                                <li>昵称：${sessionScope.customer.name }</li>
                                <li>手机号：${sessionScope.customer.phone }</li>
                                <li>邮箱：${sessionScope.customer.email }</li>
                                <li>小区名称：${sessionScope.customer.plot_name }</li>
                                <li>地址：${sessionScope.customer.address }</li>
                            </ul>
                        </div>
                    </div>
                </div>
