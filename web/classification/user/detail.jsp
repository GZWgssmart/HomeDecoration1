    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><a href="javascript:history.go(-1)" >返回</a></strong> / <small>订单详情表</small></div>
            </div>
                        ...
                        <div class="am-panel-bd am-scrollable-horizontal">
                            ...
                            am-text-nowrap">
                                ...
                                <c:forEach items="${requestScope.proList }" var="pro" varStatus="status">
	                                <tr>
	                                    <td>${pro.order_id }</td>
	                                    <td><a href="<%=path %>/BHsup/pro?id=${pro.product_id }">${pro.name }</a></td>
	                                    <td>${pro.total }</td>
	                                    <td>${pro.price }</td>
	                                    <td>${pro.cost }元</td>
	                                    <td>已支付</td>
                            ...
                            <ul class="am-pagination am-pagination-centered">
                                <c:choose>
									...
									<c:otherwise>
										<li><a href="<%=path %>/cart/detail?pageNo=1" class="am-btn">&laquo;首页</a></li>
	                                	<li><a href="<%=path %>/cart/detail?pageNo=${requestScope.pageNo - 1 }" class="am-btn">上一页</a></li>
									</c:otherwise>
								</c:choose>
								<c:choose>
									...
									<c:otherwise>
										<li><a href="<%=path %>/cart/detail?pageNo=${requestScope.pageNo + 1 }" class="am-btn">下一页</a></li>
                                		<li><a href="<%=path %>/cart/detail?pageNo=${requestScope.pageCount }" class="am-btn">尾页&raquo;</a></li>
									</c:otherwise>
								</c:choose>
