    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><a href="javascript:history.go(-1)" >返回</a></strong> / <small>修改密码</small></div>
            </div>
                    ...
                    <div class="am-panel am-panel-default">
                        <div class="am-panel-bd">
                            <form id="form" method="post" class="am-form am-form-horizontal">
                                ...
                                <input type="hidden" id="email" name="email" value="${sessionScope.customer.email }">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-form-group">
                                    <div class="am-u-sm-10 am-u-sm-offset-2">
                                        <input type="button" value="提交修改" onclick="cus_pwd();" class="am-btn am-btn-primary am-btn-block">
                                    </div>
                                </div>
                            </form>
                        </div>
