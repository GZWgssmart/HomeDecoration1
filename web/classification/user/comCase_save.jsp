                        ...
                        <div class="am-panel-bd am-scrollable-horizontal">
                                ...
                                <c:forEach items="${requestScope.comCaseList }" var="comCase" varStatus="status">
	                                <tr>
	                                    ...
	                                    <td>
	                                        ...
	                                        <a class="am-btn am-btn-primary" href="<%=path %>/cusMan/del_comCase?id=${comCase.id }">停用</a>
	                                    </td>
	                                </tr>
                                </c:forEach>
                            </table>
                            <ul class="am-pagination am-pagination-centered">
                                <c:choose>
									...
									<c:otherwise>
										<li><a href="<%=path %>/cusMan/comCaseSave?pageNo=1" class="am-btn">&laquo;首页</a></li>
	                                	<li><a href="<%=path %>/cusMan/comCaseSave?pageNo=${requestScope.pageNo - 1 }" class="am-btn">上一页</a></li>
									</c:otherwise>
								</c:choose>
								<c:choose>
									...
									<c:otherwise>
										<li><a href="<%=path %>/cusMan/comCaseSave?pageNo=${requestScope.pageNo + 1 }" class="am-btn">下一页</a></li>
                                		<li><a href="<%=path %>/cusMan/comCaseSave?pageNo=${requestScope.pageCount }" class="am-btn">尾页&raquo;</a></li>
									</c:otherwise>
								</c:choose>
