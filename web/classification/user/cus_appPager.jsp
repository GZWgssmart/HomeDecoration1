                    ...
                    <div class="am-panel am-panel-default">
                        <div class="am-panel-bd am-scrollable-horizontal">
                            ...
                            am-text-nowrap">
                                ...
                                <c:forEach items="${requestScope.cusApp }" var="comp" varStatus="status">
	                                <tr>
	                                    <td>${comp.name }</td>
	                                    <td>${comp.phone }</td>
	                                    ...
	                                    <td>${comp.budget }</td>
	                                    <td>
	                                        <a class="am-btn am-btn-primary" href="<%=path %>/cus/del_app?id=${comp.id }">取消</a>
	                                    </td>
	                                </tr>
                                </c:forEach>
                            </table>
							...
							<ul class="am-pagination am-pagination-centered">
                                <c:choose>
									...
									<c:otherwise>
										<li><a href="<%=path %>/cus/app?pageNo=1" class="am-btn">&laquo;首页</a></li>
	                                	<li><a href="<%=path %>/cus/app?pageNo=${requestScope.pageNo - 1 }" class="am-btn">上一页</a></li>
									</c:otherwise>
								</c:choose>
								<c:choose>
									...
									<c:otherwise>
										<li><a href="<%=path %>/cus/app?pageNo=${requestScope.pageNo + 1 }" class="am-btn">下一页</a></li>
                                		<li><a href="<%=path %>/cus/app?pageNo=${requestScope.totalPage }" class="am-btn">尾页&raquo;</a></li>
									</c:otherwise>
								</c:choose>
