                    ...
                    <div class="am-panel am-panel-default">
                        <div class="am-panel-bd">
                            ...
                            <ul class="am-list am-list-static am-g-fixed">
                                <li>公司名称：${sessionScope.company.name }</li>
                                <li>邮箱： ${sessionScope.company.email }</li>
                                <li>固定电话：${sessionScope.company.tel }</li>
                                <li>手机号：${sessionScope.company.phone }</li>
                                <li>负责人：${sessionScope.company.principal }</li>
                                <li>地址：${sessionScope.company.address }</li>
                                <li>成立时间：${sessionScope.company.openDate }</li>
                                <li>经度：${sessionScope.company.longitude }</li>
                                <li>纬度：${sessionScope.company.latitude }</li>
                            </ul>
                        </div>
                    </div>
                </div>
