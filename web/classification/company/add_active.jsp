    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><a href="javascript:history.go(-1)" >返回</a></strong> / <small>新建活动案例</small></div>
            </div>
                            ...
                            <form id="form" class="am-form am-form-horizontal" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="am-form-group">
                                    <div class="am-u-sm-12">
                                        <input type="submit" class="am-btn am-btn-primary am-btn-block" value="提交案例" onclick="company_case_add_active();"/>
                                    </div>
                                </div>
                            </form>
                        </div>
