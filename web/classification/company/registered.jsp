    ...
    <div class="am-u-lg-6 am-u-md-8 am-u-sm-centered">
        ...
        <span id="error">${requestScope.error }</span>
            <div class="am-form-group">
                <label for="compname" class="am-u-sm-2 am-form-label">公司名称</label>
                <div class="am-u-sm-10">
                    <input type="text" id="compname" name="compname" placeholder="输入你的公司名称">
                </div>
            </div>

            <div class="am-form-group">
                <label for="email" class="am-u-sm-2 am-form-label">公司邮箱</label>
                <div class="am-u-sm-10">
            ...
            <div class="am-form-group">
                <div class="am-u-sm-10 am-u-sm-offset-2">
                    <input type="button" class="am-btn am-btn-primary am-btn-block" value="提交注册" onclick="company_Reg();"/>
                </div>
            </div>
