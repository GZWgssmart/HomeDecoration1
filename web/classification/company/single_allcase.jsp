                ...
                <div class="am-u-sm-12 am-u-lg-10 am-u-lg-offset-1">
                    <div class="am-panel am-panel-default">
                        <div class="am-panel-bd">
                            ...
                            <hr>
                            <div>
                                <p class="am-text-xxl am-text-center font-style"><a href="<%=path %>/BHcompany/comp?id=${requestScope.com.id }">${requestScope.com.name }公司</a>的所有案例</p>
                            </div>
                            <hr>
                            <div class="am-cf am-padding">
                                <div class="am-fl am-cf"><strong class="am-text-primary am-text-xl">所有案例</strong></div>
                            </div>
                            <div class="am-g">
                            	<c:forEach items="${requestScope.allCase }" var="comp" end="2" varStatus="status">
                                <div class="am-u-sm-4">
                                    <div class="am-thumbnail" id="allCase1">
                            ...
                            <div class="am-g">
                                ...
                                <div class="am-u-sm-4">
                                    <div class="am-thumbnail" id="allCase2">
                                        <a href="<%=path %>/BHcompany/case1?id=${comp.id }"><img src="<%=path %>/${comp.image_1 }" alt="" class="img-rounded"/></a>
                                        <div class="am-thumbnail-caption">
                                            <h4>案例名称:${comp.name }</h4>
                                            <p class="am-text-truncate">案例描述:${comp.des }</p>
                            ...
                            <div class="am-g">
                                ...
                                <div class="am-u-sm-4">
                                    <div class="am-thumbnail" id="allCase3">
                                        <a href="<%=path %>/BHcompany/case1?id=${comp.id }"><img src="<%=path %>/${comp.image_1 }" alt="" class="img-rounded"/></a>
                                        <div class="am-thumbnail-caption">
                                            <h4>案例名称:${comp.name }</h4>
                                            <p class="am-text-truncate">案例描述:${comp.des }</p>
                            ...
                            <div class="am-g">
                                ...
                                <div class="am-u-sm-4">
                                    <div class="am-thumbnail" id="allCase4">
                                        <a href="<%=path %>/BHcompany/case1?id=${comp.id }"><img src="<%=path %>/${comp.image_1 }" alt="" class="img-rounded"/></a>
                                        <div class="am-thumbnail-caption">
                                            <h4>案例名称:${comp.name }</h4>
                                            <p class="am-text-truncate">案例描述:${comp.des }</p>
                                    ...
                                    <div class="am-tab-panel am-fade am-in am-active" id="tab1">
                                    	<ul class="am-pagination am-pagination-centered">
			                                <c:choose>
												...
												<c:otherwise>
													<li><a href="<%=path %>/BHcompany/single_allcase?pageNo=1&id=${requestScope.com.id }" class="am-btn">&laquo;首页</a></li>
				                                	<li><a href="<%=path %>/BHcompany/single_allcase?pageNo=${requestScope.pageNo - 1 }" class="am-btn">上一页</a></li>
												</c:otherwise>
											</c:choose>
											<c:choose>
												...
												<c:otherwise>
													<li><a href="<%=path %>/BHcompany/single_allcase?pageNo=${requestScope.pageNo + 1 }" class="am-btn">下一页</a></li>
			                                		<li><a href="<%=path %>/BHcompany/single_allcase?pageNo=${requestScope.totalPage }" class="am-btn">尾页&raquo;</a></li>
												</c:otherwise>
											</c:choose>
