                ...
                <div class="am-u-sm-12 am-u-lg-10 am-u-lg-offset-1">
                    ...
                    <span id="error">${requestScope.error }</span>
                        <div class="am-panel-bd">
                            <form id="form" method="post" action="<%=path %>/company/headupdate" class="am-form am-form-horizontal" enctype="multipart/form-data">
                                <img class="am-radius avatar am-center am-img-responsive" alt="${sessionScope.company.name }" src="<%=path %>/${sessionScope.company.logo }" />
                                <hr>
                                <div class="am-form-group am-form-file am-container">
                                    <div class="btn-width am-center">
                                        <input type="button" class="am-btn am-btn-default am-btn-sm am-btn-warning am-center" value="上传新logo"/>
