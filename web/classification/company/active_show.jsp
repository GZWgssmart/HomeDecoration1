    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><a href="javascript:history.go(-1)" >返回</a></strong> / <small>公司的单个案例</small></div>
            </div>
                        ...
                        <div class="am-panel-bd">
                            ...
                            <form id="form" class="am-form am-form-horizontal" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="am-form-group">
                                    <label for="name" class="am-u-sm-4 am-u-sm-offset-4 am-form-label">活动名称： ${requestScope.show.name }</label>
                                </div>
                                ...
                                <ul class="am-avg-sm am-thumbnails">
                                    <li>
                                        <div class="am-form-group am-form-file">
                                        	<c:if test="${requestScope.show.image != null}">
                                            <img style="width:100%" src="<%=path %>/${requestScope.show.image }" />
                                       	</c:if>
                                       	<c:if test="${requestScope.show.image == null}">
                                            <img style="width:100%" src="<%=path %>/img/null.jpg" />
                                       	</c:if>
                                        </div>
                                    </li>
                                </ul>
