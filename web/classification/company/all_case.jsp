                    ...
                    <div class="am-panel am-panel-default">
                        <div class="am-panel-bd">
                            <div class="am-cf am-padding">
                                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><a href="javascript:history.go(-1)" >返回</a></strong> / <small>装修公司的所有案例</small></div>
                            </div>
                            <hr>
                            <div>
                                <p class="am-text-xxl am-text-center font-style">所有装修公司的案例</p>
                            </div>
                            <hr>
                            <div class="am-cf am-padding">
                                <div class="am-fl am-cf"><strong class="am-text-primary am-text-xl">每月热门装修案例</strong></div>
                            </div>
                            <div class="am-g">
                            	<c:forEach items="${requestScope.allCase }" var="comp" end="2" varStatus="status">
                                <div class="am-u-sm-4">
                                    <div class="am-thumbnail" id="comcase1">
                                        <a href="<%=path %>/BHcompany/case1?id=${comp.id }"><img src="<%=path %>/${comp.image_1 }" alt="" class="img-rounded"/></a>
                                        <div class="am-thumbnail-caption">
                                            <h4>案例名称:${comp.name }</h4>
                                            <p class="am-text-truncate">案例描述:${comp.des }</p>
                                            <p>
                                                <a href="<%=path %>/BHcompany/case1?id=${comp.id }" class="am-btn am-btn-secondary am-btn-block am-round">查看</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="am-g">
                                ...
                                <div class="am-u-sm-4">
                                    <div class="am-thumbnail" id="comcase2">
                                        <a href="<%=path %>/BHcompany/case1?id=${comp.id }"><img src="<%=path %>/${comp.image_1 }" alt="" class="img-rounded"/></a>
                                        <div class="am-thumbnail-caption">
                                            <h4>案例名称:${comp.name }</h4>
                                            <p class="am-text-truncate">案例描述:${comp.des }</p>
                            ...
                            <div class="am-g">
                                ...
                                <div class="am-u-sm-4">
                                    <div class="am-thumbnail" id="comcase3">
                                        <a href="<%=path %>/BHcompany/case1?id=${comp.id }"><img src="<%=path %>/${comp.image_1 }" alt="" class="img-rounded"/></a>
                                        <div class="am-thumbnail-caption">
                                            <h4>案例名称:${comp.name }</h4>
                                            <p class="am-text-truncate">案例描述:${comp.des }</p>
                            ...
                            <div class="am-g">
                                ...
                                <div class="am-u-sm-4">
                                    <div class="am-thumbnail" id="comcase4">
                                        <a href="<%=path %>/BHcompany/case1?id=${comp.id }"><img src="<%=path %>/${comp.image_1 }" alt="" class="img-rounded"/></a>
                                        <div class="am-thumbnail-caption">
                                            <h4>案例名称:${comp.name }</h4>
                                            <p class="am-text-truncate">案例描述:${comp.des }</p>
                            ...
                            <hr>
                                ...
                                <c:choose>
									...
									<c:otherwise>
										<li><a href="<%=path %>/BHcompany/allcase?pageNo=1" class="am-btn">&laquo;首页</a></li>
	                                	<li><a href="<%=path %>/BHcompany/allcase?pageNo=${requestScope.pageNo - 1 }" class="am-btn">上一页</a></li>
									</c:otherwise>
								</c:choose>
								<c:choose>
									...
									<c:otherwise>
										<li><a href="<%=path %>/BHcompany/allcase?pageNo=${requestScope.pageNo + 1 }" class="am-btn">下一页</a></li>
                                		<li><a href="<%=path %>/BHcompany/allcase?pageNo=${requestScope.totalPage }" class="am-btn">尾页&raquo;</a></li>
									</c:otherwise>
								</c:choose>
