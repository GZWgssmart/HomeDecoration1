    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><a href="javascript:history.go(-1)" >返回</a></strong> / <small>编辑活动</small></div>
            </div>
					  ...
					  <input type="hidden" id="id" name="id" value="${requestScope.edit.id }"/>
                                ...
                                <ul class="am-avg-sm am-thumbnails">
                                    <li>
                                        <div class="am-form-group am-form-file">
                                        	<c:if test="${requestScope.edit.image != null}">
                                            <a href="#"><img class="am-thumbnail" src="<%=path %>/${requestScope.edit.image }" /></a>
                                ...
                                <div class="am-form-group">
                                    <div class="am-u-sm-12">
                                        <input type="submit" class="am-btn am-btn-primary am-btn-block" value="提交案例" onclick="company_case_edit_active();"/>
                                    </div>
                                </div>
                            </form>
                        </div>
